...
public class Utils {
	...
	public static byte uint32_get_b0(int input) {
		return (byte) (input & 0xFF);
	}

	public static byte uint32_get_b1(int input) {
		return (byte) ((input >>> 8) & 0xFF);
	}

	public static byte uint32_get_b2(int input) {
		return (byte) ((input >>> 16) & 0xFF);
	}

	public static byte uint32_get_b3(int input) {
		return (byte) ((input >>> 24) & 0xFF);
	}
	...
	public static byte castLongtoByte(long x) {
		return (byte) (x & 0x00000000000000ffL);
	}

	public static short castLongtoShort(long x) {
		return (short) (x & 0x000000000000ffffL);
	}
	...
	public static int getUInt(byte x) {
		return x & 0x000000ff;
	}
	...
	public static String getCurrentTime(){
		...
		return Integer.toString(hour) + ":" + Integer.toString(time.getMinute()) + ":" +Integer.toString(time.getSecond());
	}
}
